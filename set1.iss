...
AppId={{574C6E38-94F9-4D69-902B-0E3AD123B4BB}
AppName={#MyAppName}
...
Source: "C:\Users\admin\Desktop\output\My App\Set.iss"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Users\admin\Desktop\output\My App\tcl\*"; DestDir: "{src}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\admin\Desktop\output\My App\tcl8\*"; DestDir: "{src}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\admin\Desktop\output\My App\tk\*"; DestDir: "{src}"; Flags: ignoreversion recursesubdirs createallsubdirs
